...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @var Collection<int, Actus>
     */
    #[ORM\OneToMany(targetEntity: Actus::class, mappedBy: 'auteur')]
    ...
    public function addActu(Actus $actu): static
    {
    ...
    public function removeActu(Actus $actu): static
    {
